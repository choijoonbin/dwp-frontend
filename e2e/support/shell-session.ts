...
export const FULL_PRODUCT_PERMISSIONS = [
  ...
  ...[
    ['ACTION.WORKFORCE_REFERENCE', 'MANAGE'],
    ['ACTION.WORKFORCE_DATA_OPERATIONS', 'MANAGE'],
    ['ACTION.WORKFORCE_ORG_DESIGN', 'VIEW'],
    ['ACTION.WORKFORCE_CONTROLLED_EXPORT', 'VIEW'],
  ...
  ...[
    ...
    ['ADMIN.MAIL', 'VIEW'],
    ['ADMIN.MAIL', 'CONNECTION_MANAGE'],
    ['ADMIN.MAIL', 'SHARED_INBOX_MANAGE'],
    ['ADMIN.MAIL', 'POLICY_MANAGE'],
    ['ADMIN.MAIL', 'HOLD_MANAGE'],
    ['ADMIN.MAIL', 'PURGE_AUTHORIZE'],
    ['ADMIN.MAIL', 'PURGE_EXECUTE'],
    ['ADMIN.MAIL', 'AUDIT_READ'],
    ['ADMIN.MAIL', 'RECOVERY'],
    ['ADMIN.MAIL', 'EXPORT'],
    ['ADMIN.MAIL', 'WRITING_ASSET_EDIT'],
    ['ADMIN.MAIL', 'WRITING_ASSET_SUBMIT'],
    ['ADMIN.MAIL', 'WRITING_ASSET_APPROVE'],
    ['ADMIN.MAIL', 'WRITING_ASSET_PUBLISH'],
    ['ADMIN.MAIL', 'WRITING_ASSET_RETIRE'],
    ['ADMIN.MEETINGS', 'VIEW'],
