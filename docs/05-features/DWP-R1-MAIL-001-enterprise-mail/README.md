...
[화면 수용안, 주소록·그룹 발송 계약, 실행 확장 경계 및 잔여 Gate](02-home-and-action-experience.md)에 통합 관리합니다. 참고 화면의 구성은 DWP 공통 셸과 디자인 시스템에 적용하며 외부 실행·발송이 준비되지 않은 기능을 완료 상태로 표시하지 않습니다.
