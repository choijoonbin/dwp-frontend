...
- `DWP-R1-CORE-006-product-surface-separation`: 업무·팀·제품 운영·관리 Surface와 Scope 분리
- `DWP-R1-CORE-007-flow-home-personalization`: App Dock·업무 Flow·단일 Scroll·제약형 개인화 Home vNext
