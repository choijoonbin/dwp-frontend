> **HISTORICAL / SUPERSEDED · 2026-09-08:** 이 문서는 폐기된 Work 내부 서비스 응답 경로의 당시 활성화 검토 기록입니다. 현재 Work는 서비스 요청을 읽기 전용으로 표시하고 Services 원본으로 handoff하며, 아래 v6 활성화 내용을 현재 Work 완료 조건이나 제공 기능으로 사용하지 않습니다.
