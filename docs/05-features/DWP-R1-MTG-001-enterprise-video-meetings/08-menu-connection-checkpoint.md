...
> **2026-09-07 정정:** 아래 완료 표현은 과거 연결/자체 회귀 범위를 기록한 것이며 승인 디자인 충실도의 최종 합격으로 사용할 수 없다. U06–U15 desktop/mobile 20개 재대조에서 콘텐츠 생략·다른 레이아웃·모바일 본문 접힘이 확인되어 재개발 중이다. 최신 판정은 `09-design-correction-20-screens-2026-09-07.md`를 따른다.
