...
export default function HomePage() {
  ...
  const backgroundPosition = homeExperience?.backgroundUrl
    ? `${homeExperience.backgroundPosition.toLowerCase()} top`
    : 'right center';
  const backgroundSize = homeExperience?.backgroundUrl ? 'cover' : 'auto 165%';
      ...
      <PageCanvas>
        ...
        >
          <Box sx={{ p: { xs: 2.5, sm: 3, lg: 4 } }}>
            ...
            >
              Two decisions before the 11:00 customer meeting. Approving software access now
              unblocks a new team member; the customer brief still has three unanswered questions.
            </Typography>
            ...
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mt: 2.5 }}>
              ...
              <Button
                ...
                onClick={() =>
                  navigate(
                    '/ask?q=What%20should%20I%20prepare%20before%20the%2011%3A00%20meeting%3F'
                  )
                }
                sx={{
                  color: '#F8FAFC',
