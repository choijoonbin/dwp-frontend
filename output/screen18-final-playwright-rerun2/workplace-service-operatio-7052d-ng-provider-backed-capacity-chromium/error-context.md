            ...
            - generic [ref=e320]:
              ...
              - generic [ref=e517]:
                - generic [ref=e518]:
                  ...
                  - generic [ref=e520]:
                    - combobox "Capacity mode Time buckets" [ref=e521] [cursor=pointer]: Time buckets
                    - textbox: BUCKETED
                    - img
                    - group:
              ...
              - generic [ref=e587]:
                - generic [ref=e588]: Change reason
                - generic [ref=e589]:
                  - textbox "Change reason" [ref=e590]: Enable verified time-slot capacity
                  - group:
                    - generic: Change reason
              - generic [ref=e591] [cursor=pointer]:
                - generic [ref=e592]:
                  - checkbox "I verified provider truth, site scope, options, pricing, cutoff, and cancellation policy." [checked] [active] [ref=e593]
                  - img [ref=e594]
                - generic [ref=e596]: I verified provider truth, site scope, options, pricing, cutoff, and cancellation policy.
              - button "Save" [disabled]
  - generic "Open DWAI·ON" [ref=e598]:
    - button "Open DWAI·ON" [ref=e599] [cursor=pointer]
```